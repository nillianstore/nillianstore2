...
Nillianstore is a curated online storefront operating from **Abu Dhabi, United Arab Emirates**. We handpick and showcase home decor, lifestyle, and tea accessory products available on **Amazon.ae**. When you click "Buy on Amazon.ae" on any product page, you are redirected to Amazon.ae to complete your purchase.
...
- You are at least 18 years of age or accessing the site under parental supervision
- You are legally able to enter into binding agreements under UAE law
...
### Permitted Use
- Browsing product listings and reading blog content
- Using the search feature to find products
- Clicking through to Amazon.ae to make purchases
- Contacting us with legitimate questions

### Prohibited Use
- Scraping, copying, or redistributing our product content without permission
- Using automated tools to overwhelm or disrupt website functionality
- Attempting to access non-public areas of the website
...
- Pricing (displayed in AED — UAE Dirham)
- Images and specifications

However, we cannot guarantee that:
- Product information is always current or error-free
- Prices displayed on our site will exactly match Amazon.ae at the time of purchase (Amazon controls final pricing)
- Product availability remains unchanged after we publish a listing
...
When you click "Buy on Amazon.ae," you are redirected to the official Amazon.ae website where:
- Your purchase is processed by Amazon.ae
- Amazon's terms of service apply to your transaction
- Amazon handles payment processing, shipping, and returns
- Amazon's buyer protection policies cover your order
...
All content on nillianstore.com, including but not limited to:
- Original text, product descriptions, and blog articles
- Curated product collections and category organization
- Website design, layout, and graphics
- Our logo and brand name "Nillianstore"
...
### No Warranties
Our website is provided "as is" and "as available" without warranties of any kind, either express or implied. We do not warrant that:
- The website will be uninterrupted or error-free
- Product information is completely accurate or current
- Defects or errors will be corrected immediately

### Limitation of Liability
Nillianstore shall not be liable for:
- Any issues arising from purchases made on Amazon.ae (these are governed by Amazon's policies)
...
- Amazon.ae for product purchases
- Social media platforms (Instagram, Facebook, TikTok)
- Google Analytics and tracking services
...
Since all purchases are fulfilled by Amazon.ae, returns and refunds are governed by Amazon's return policy. However, we have our own [Refund & Return Policy](/refund-policy/) that outlines the process and our commitment to helping you resolve any issues.

For order-specific return requests, please:
1. Log into your Amazon.ae account
2. Navigate to "Your Orders"
3. Select the item and follow Amazon's return process

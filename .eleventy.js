...
module.exports = function (eleventyConfig) {
  ...
  // ✅ Filters
  // Homepage thumb: /img/B0XXXX.webp -> /img/B0XXXX-400.webp (400px variant
  // generated by scripts/optimize-images.js). Falls back to the original when
  // the filename isn't a product cover.
  eleventyConfig.addFilter('thumb', (src) => {
    if (!src) return src;
    return String(src).replace(/^(\/img\/B0[A-Z0-9]+)\.webp$/i, '$1-400.webp');
  });
